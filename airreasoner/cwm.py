...
from tmswap import  diag
from tmswap.why import  explainFormula, newTopLevelFormula
from tmswap.diag import verbosity, setVerbosity, progress, tracking, setTracking
from tmswap.uripath import join, splitFrag
from tmswap.webAccess import urlopenForRDF, load, sandBoxed 

from tmswap import  notation3            # N3 parsers and generators
from tmswap import  toXML                 #  RDF generator

from tmswap.why import BecauseOfCommandLine
from tmswap.query import think, applyRules, applyQueries, applySparqlQueries, testIncludes
from tmswap.update import patch
...
#            _equals = string.find(arg, "=")
            ...
            #    sys.argv[argnum+1:argnum+1] = ['-think', '-filter=' + _rhs]
                ...
                try:
                    from tmswap import  sax2rdf      # RDF1.0 syntax parser to N3 RDF stream
